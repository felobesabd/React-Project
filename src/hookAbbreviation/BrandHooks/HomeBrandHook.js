...
import notify from './../../hookAbbreviation/ToastifyAbbr';
import { CreateBrandAction } from './../../Reducer/Actions/BrandActions';
...
// Func => Get Img And Change Img 
  ...
  const res = useSelector(state => state.allBrandRed.brand)
