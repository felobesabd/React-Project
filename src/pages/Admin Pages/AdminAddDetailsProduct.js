...
import AddDetProductHook from "../../hookAbbreviation/ProductHooks/AddDetProductHook";
...
const AdminAddDetailsProduct = () => {
    ...
    const [onChangeProdName, onChangeDesName, onChangePriceBefore, onChangePriceAfter, onChangeQty,
        ...
        handleData, product] = AddDetProductHook()
...
//ErrorAxiosError: Request failed with status code 500